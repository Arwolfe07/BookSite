# BookSite (WolfeChemE)
Download Chemical Engineering Books. Be sure to register first.
...
* This project is complete - [Link](https://wolfecheme.onrender.com/)
* Users can only download books after creating an account
* Admin (currently me) can only upload new books
...
9. [Cloudinary](https://cloudinary.com/) - Image and file upload service

## Getting Started

### Clone or download this repository
```sh
git clone https://github.com/Arwolfe07/BookSite.git
```
